...
internal class Hex5AEncoder_ACS : IEncoder_ACS
{
    ...
    public OperateResult<byte[ ]> Packet_GetRanges ( )
    {
        ...
        return _encodeHelper. EncodeHelper ( Hex5A. GetRanges_ACS , Hex5A. GetRanges_ACS_Len , data );
    }

    public OperateResult<byte[ ]> Packet_Open ( )
    {
        SetStandardSourceArgs[ ] args = new SetStandardSourceArgs[2];
        args[0] = new SetStandardSourceArgs ( Channels. Uabc , 0 );
        args[1] = new SetStandardSourceArgs ( Channels. Iabc , 0 );
        return SetArgs_ACS ( Type_SetStandardSource. Amplitude , args );
    }

    public OperateResult<byte[ ]> Packet_ReadData ( )
    {
        return _encodeHelper. EncodeHelper ( Hex5A. ReadData_ACS );
    }
    ...
    public OperateResult<byte[ ]> Packet_SetAmplitude (DKCommunicationNET. Channels channel , float value )
    {
        ...
        args[0] = new SetStandardSourceArgs ( channel , value );
        return SetArgs_ACS ( Type_SetStandardSource. Amplitude , args );
    }
    ...
    public OperateResult<byte[ ]> Packet_SetHarmonics ( Enum channels , HarmonicArgs[ ] harmonics )
    {
        ...
        return _encodeHelper. EncodeHelper ( Hex5A. SetHarmonics , ( ushort ) ( 11 + data. Length ) , data );
    }
    ...
    {
        SetStandardSourceArgs[ ] args = new SetStandardSourceArgs[1];
        args[0] = new SetStandardSourceArgs ( channels , value );
        return SetArgs_ACS ( Type_SetStandardSource. Phase , args );
    }
    ...
    {
        SetStandardSourceArgs[ ] args = new SetStandardSourceArgs[2];
        args[0] = new SetStandardSourceArgs ( Channels. Uabc , -1 );
        args[1] = new SetStandardSourceArgs ( Channels. Iabc , -1 );
        return SetArgs_ACS ( Type_SetStandardSource. Amplitude , args );
    }
    ...
    public OperateResult<byte[ ]> Packet_ClearHarmonics ( Enum Channels )
    {
        ...
        data[1] = 0;
        return _encodeHelper. EncodeHelper ( Hex5A. SetHarmonics , Hex5A. SetHarmonics_Clear_L , data );
    }
    ...
    private OperateResult<byte[ ]> SetModeAndRanges_ACS ( Flag_SetType flag_Type , ACSWorkingMode workMode , WireMode wireMode , CloseLoopMode closeLoopMode , HarmonicMode harmonicMode , QP_Mode qP_Mode , byte[ ] rangs )
    {
        ...
        return _encodeHelper. EncodeHelper ( Hex5A. SetSystemModeAndRanges , Hex5A. SetSystemModeAndRanges_L , data );
    }
    ...
    private OperateResult<byte[ ]> SetArgs_ACS ( Type_SetStandardSource type , SetStandardSourceArgs[ ] args )
    {
        ...
        //返回结果
        return _encodeHelper. EncodeHelper ( Hex5A. SetStandardSource , ( ushort ) ( 11 + data. Length ) , data );
    }
    #endregion
}
