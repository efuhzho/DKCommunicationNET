...
{   
    public DeviceHex81 ( )
    {
        _protocolType = ProtocolTypes. Hex81;
    }
    ...
    public void DO ( ) 
    {
        ...
        this.ModuleACS=new ModuleACS();
        ModuleACS. SetACSAmplitude ( 100.005f); 
    }
    public void DO2 ( )
    {
        this. ModuleACS = new ModuleACS_TEST ( );
        ModuleACS. SetACSAmplitude (200.005f );
    }
}
